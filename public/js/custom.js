...
(function($)  {
    ...
    // INIT ISOTOPE
    var $imageGrid = $(".image-tab.tab-grid").isotope({
    ...
    $(".image-button-group.filter-button-group").on(
        "click",
        "button",
        function () {
            var filterValue = $(this).attr("data-filter");
            $imageGrid.isotope({ filter: filterValue });
            $(".grid").isotope({
                hiddenStyle: {
                    opacity: 0,
                },
    ...
    $(".image-button-group.filter-button-group").each(function (
        i,
        buttonGroup
    ) {
    ...
    // INIT ISOTOPE
    var $videoGrid = $(".video-tab.tab-grid").isotope({
    ...
    $videoGrid.imagesLoaded().progress(function () {
        $videoGrid.isotope("layout");
    });

    // FILTER ITEMS ON BUTTON CLICK
    $(".video-button-group.filter-button-group").on(
        "click",
        "button",
        function () {
            var filterValue = $(this).attr("data-filter");
            $videoGrid.isotope({ filter: filterValue });
            $(".grid").isotope({
                hiddenStyle: {
                    opacity: 0,
                },
    ...
    // CHANGE ACTIVE CLASS ON FILTER ISOTOPE BUTTONS
    $(".video-button-group.filter-button-group").each(function (
        i,
        buttonGroup
    ) {
        var $buttonGroup = $(buttonGroup);
